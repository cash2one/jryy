...
DATABASES = {
    'default': {
        ...
        'NAME': './data/reserved.sqlite',                      # Or path to database file if using sqlite3.
...
MEDIA_URL = 'http://dev.zh.ongl.in/media/'
...
SECRET_KEY = '0d8=jmm%7e!ead5h-*b)8w=f3&_=73&ua^j4$(1hmbn@3x-w+0'
